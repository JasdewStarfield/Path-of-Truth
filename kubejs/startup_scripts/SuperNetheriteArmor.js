...

{
    ...
    // 法术强度
    let attrIncPower = new AttributeModifier('add power', 0.15, AttributeModifier.Operation.MULTIPLY_BASE)
    // 冷却缩减
    let attrIncCD = new AttributeModifier('add cd', 0.05, AttributeModifier.Operation.MULTIPLY_TOTAL)

    ForgeEvents.onEvent('net.minecraftforge.event.ItemAttributeModifierEvent', e => global.InjectIronsSpellsArmor(e))
    global.InjectIronsSpellsArmor = (/**@type {Internal.ItemAttributeModifierEvent}*/ e) => {
