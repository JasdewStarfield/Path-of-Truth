ServerEvents.recipes(event => {
  ...
  event.custom({
    "type": "immersiveengineering:arc_furnace",
    "energy": 153600,
    "additives": [{ "base_ingredient": { "item": "scguns:anthralite_ingot" }, "count": 1 }],
    "input": { "base_ingredient": { "item": "kubejs:unformed_steel_ingot" }, "count": 2 },
    "results": [{"base_ingredient":{"tag":"forge:ingots/steel"},"count":2}],
    "time": 200
  })
  /*
  event.custom({
    ...
    "energy":204800,
    "input":{"base_ingredient":{"item":"kubejs:unformed_steel_ingot"},"count":2},
    "additives":[{"item":"scguns:anthralite_ingot"}],
    "results":{"base_ingredient":{"tag":"forge:ingots/steel"},"count":2},
    "time":200
  })
  */
