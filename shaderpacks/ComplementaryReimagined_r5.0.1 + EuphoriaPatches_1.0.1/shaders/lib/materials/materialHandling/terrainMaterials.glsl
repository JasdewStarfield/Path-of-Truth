                                ...
                                if (color.r > 0.1 && color.g + color.b < 0.1) { // Redstone Parts
                                    ...
                                    if (color.r > 0.5) {
                                        ...
                                        emission = 8.0 * color.r;
                                            ...
                                            floorNoiseIntensity = 0.35;
                                            floorNoiseEmission = 0.2;
                                        #endif
                        ...
                        if (mat < 10056) {
                            ...
                            if (mat == 10056) { // Lava Cauldron
                                ...
                                if (color.r > color.g + color.b) {
                                    ...
                                    emission = 4.0;
                                    #if SEASONS == 1 || SEASONS == 4 || defined MOSS_NOISE || defined SAND_NOISE 
                                        floorNoiseIntensity = 0.1;
                                        floorNoiseEmission = 0.3;
                                    #endif
                                } else {
                        ...
                        if (mat < 10216) {
                            ...
                            if (mat == 10216) { // Crimson Stem, Crimson Hyphae
                                if (color.r / color.b <= 2.5) { // Flat Part
                                    ...
                                    color.gb *= 0.5;
                                    #if SEASONS == 1 || SEASONS == 4 || defined MOSS_NOISE || defined SAND_NOISE
                                        floorNoiseIntensity = 0.6;
                                        floorNoiseEmission = 0.15;
                                    #endif
                                }
                                #endif
                            }
                            ...
                            if (mat == 10320) { // Diamond Ore
                                if (color.b / color.r > 1.5 || color.b > 0.8) { // Diamond Ore:Diamond Part
                                    #include "/lib/materials/specificMaterials/terrain/diamondBlock.glsl"
                                        ...
                                        emission = color.g + 1.5;
                                        #if SEASONS == 1 || SEASONS == 4 || defined MOSS_NOISE || defined SAND_NOISE
                                            floorNoiseIntensity = 0.75;
                                            floorNoiseEmission = 0.4;
                                        #endif
                                        #ifdef SITUATIONAL_ORES
                                            float skyLightFactor = pow2(1.0 - min1(lmCoord.y * 2.9 * sunVisibility));
                                            emission *= skyLightFactor;
                    ...
                    if (mat < 10528) {
                        if (mat < 10520) {
                            ...
                            if (mat == 10520) { // Cactus
                                ...
                                smoothnessG = factor * 0.5;
                                highlightMult = factor;
                                #if defined SAND_NOISE || defined MOSS_NOISE
                                    floorNoiseIntensity = 0.0;
                                #endif
                            }
                        ...
                        if (mat < 10616) {
                            if (mat == 10608) { // Redstone Block
                                #include "/lib/materials/specificMaterials/terrain/redstoneBlock.glsl"
                                    ...
                                    #ifdef SNOWY_WORLD
                                        snowFactor = 0.0;
                                    #elif SEASONS == 1 || SEASONS == 4 || defined MOSS_NOISE || defined SAND_NOISE 
                                        floorNoiseIntensity = 0.5;
                                    #endif
                                #endif
                            }
                    ...
                    if (mat < 10848) {
                        if (mat < 10840) {
                            ...
                            if (mat == 10840) { // Lime Concrete
                                ...
                                #ifdef BLUE_SCREEN
                                    materialMask = OSIEBCA * 241.0; // Green Screen Lime Blocks
                                #endif
                            }
